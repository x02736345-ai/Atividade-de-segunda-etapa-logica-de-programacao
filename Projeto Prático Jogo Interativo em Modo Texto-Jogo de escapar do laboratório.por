programa
{
	...
	enquanto(sala3abre==falso e hp>0)
	{
	...
	escreva("3. Fechar mochila\n")
	leia(material)
	se (material<1 ou material>3)
	{
	...
	senao
	{
	escreva("Você não possui poções.\n")
	}
	pare        
	caso 2:
	se (bomba > 0)
	...
	senao
	{
	escreva("Você não possui bombas.\n")
	}
	pare
	caso 3:
	...
	u.aguarde(1000)
	se (sala3abre==verdadeiro e hp>0)
	{
	...
	u.aguarde(3000)
	escreva("A cena diante de você era a de um ex-humano devorando um cadáver humano, deixando sangue por todo chão.\n\n")
	u.aguarde(3000)
	...
	u.aguarde(3000)
	contadorTentativas=0
	enquanto(NOx!="Redução de 4 unidades" e contadorTentativas<5)
	{
	...
	senao
	{
	se (contadorTentativas<5)
	{
	escreva("Senha incorreta!!!Tente novamente.\n")
	}
	senao
	{
	escreva("Você esgotou todas as tentativas! A porta permanece trancada.\n")
	}
	}
	}
	se (NOx=="Redução de 4 unidades")
	...
	pare
	caso 2:
	defesa=u.sorteia(100000000,999999999)		 
